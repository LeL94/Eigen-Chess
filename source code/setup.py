...
class BuildExe:
    def __init__(self):
        ...
        self.license = "EigenCraft License"

        #Auhor of program
        self.author_name = "EigenCraft Corporation"
        self.author_email = ""
        self.copyright = "Copyright (c) 2017 EigenCraft Corp."
        ...
        self.extra_datas = ['images','sounds']
